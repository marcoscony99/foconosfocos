...
from amazonia import *  # Importando as funções do arquivo amazonia.py

app = Flask(__name__)

@app.route('/amazonia')
def amazonia():
    # Código para obter dados da Amazônia e enviar e-mail
    # Aqui você pode chamar as funções e executar o código contido no arquivo amazonia.py
    # Por exemplo:
    soup = obter_html('http://terrabrasilis.dpi.inpe.br/queimadas/situacao-atual/media/bioma/grafico_historico_mes_atual_estado_amazonia.html')
    ...
    return "Dados da Amazônia obtidos e e-mail enviado!"
